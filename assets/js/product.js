    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        var productHTML = `
    <hr class="mb-4">
    	<p class="mb-1 fw-medium fs-18 text-dark">Deskripsi Product <span class="badge badge-soft-warning"><i class="bi bi-star-fill"></i><span class="mb-0 fw-medium fs-18 text-dark"> 4.2</span></span></p>
    ...
    <div class="container-text">
    	...
    	<div class="row-text">
            ...
            <span class="text-muted fs-13 value-text">Cotton Combed</span>
        </div>
        <hr class="hr-arda">
    </div>
